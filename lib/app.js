...
var _randomProfileImage = require("./randomProfileImage.js");
...
// console.log(_dirname2.default); // const __filename = fileURLToPath(import.meta.url);

var _dirname = _path.default.join(__filename, "..", "..", "package.json");
						...
						while (1) {
							switch ((_context2.prev = _context2.next)) {
								case 0:
									...
									singleMessageObject.profileImage = (0,
									_randomProfileImage.randomProfileImage)();
									singleMessageObject.currentVoteTally = 0;
									singleMessageObject.allChildComments = 0;
									(name = singleMessageObject.name),
										(date = singleMessageObject.date),
										(message = singleMessageObject.message),
										(currentVoteTally = singleMessageObject.currentVoteTally),
										(profileImage = singleMessageObject.profileImage),
										(allChildComments = singleMessageObject.allChildComments);
									_context2.next = 9;
									return (0, _comments.createNewComment)(
										modelName,
										name,
										date,
										message,
							...
							switch ((_context3.prev = _context3.next)) {
								case 0:
									...
									(name = singleMessageObject.name),
										...
										(currentVoteTally = singleMessageObject.currentVoteTally),
										(profileImage = singleMessageObject.profileImage),
										(parent_id = singleMessageObject.parent_id),
										(allChildComments = singleMessageObject.allChildComments);
									_context3.next = 9;
									return (0, _comments.createNewReply)(
										modelName,
										name,
										date,
										message,
